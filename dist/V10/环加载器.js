 ...
 */
(async function () {
    var BASE = 'https://testingcf.jsdelivr.net/gh/fkgzs123321/RimWorld-Card@main/dist/V10/';
    var MODS = ["环引擎","环特质","环经济","环战斗","环亲密","环结算","环地图","环数据","环动物","环社交","环日志","环温度","环贸易","环遗址","环通讯","环制造","环远行队","环种植","环战斗面板","环工坊","环开场","环终端"];
    var H = (function () { var w = window; try { while (w.parent && w.parent !== w) w = w.parent; } catch (e) {} return w; })();
